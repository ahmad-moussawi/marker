...
--
-- Host: localhost
-- Generation Time: Oct 18, 2013 at 01:09 PM
...
(1, 1, 'title', 'Title', '1.1', '{"required":true}', '', 1),
(2, 1, 'description', 'Description', '1.2', '{}', '', 1),
(3, 1, 'link', 'link', '1.1', '{"required":true}', '', 1),
(4, 1, 'ispublished', 'Is Published', '4.4', '{}', '', 1);
-- --------------------------------------------------------
...
(1, '5.2', 'video', '{"type":"TEXT"}', 'media'),
(2, '5.1', 'images', '{"type":"TEXT"}', 'media'),
(3, '4.4', 'boolean', '{"type":"TINYINT", "constraint":"1"}', 'list'),
(4, '4.3', 'radio', '{"type":"TEXT"}', 'list'),
(5, '4.2', 'checkbox', '{"type":"TEXT"}', 'list'),
(6, '4.1', 'select', '{"type":"TEXT"}', 'list'),
(7, '3.2', 'float', '{"type":"FLOAT"}', 'number'),
(8, '3.1', 'int', '{"type":"INT"}', 'number'),
(9, '1.3', 'rich text', '{"type":"TEXT"}', 'text'),
(10, '1.2', 'longtext', '{"type":"TEXT"}', 'text'),
(11, '1.1', 'shorttext', '{"type":"VARCHAR","constraint":"255"}', 'text'),
(12, '5.3', 'audio', '{"type":"TEXT"}', 'media'),
(13, '6.1', 'attachements', '{"type":"TEXT"}', 'files'),
(14, '1.4', 'code', '{"type":"TEXT"}', 'text'),
(15, '1.5', 'color', '{"type":"VARCHAR","constraint":"7"}', 'text'),
...
CREATE TABLE IF NOT EXISTS `lists` (
  ...
  `description` text,
  `identity` varchar(50) NOT NULL DEFAULT '' COMMENT 'Identity Column Name',
  `ispublished` tinyint(1) DEFAULT '0',
...
INSERT INTO `lists` (`id`, `internaltitle`, `mapped_table`, `title`, `description`, `identity`, `ispublished`, `created`, `modified`, `createdby`, `modifiedby`, `protected`) VALUES
