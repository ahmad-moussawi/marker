...
--
-- Host: localhost
-- Generation Time: Oct 23, 2013 at 06:04 AM
...
(3, 1, 'title', 'Title', '1.1', '{"required":true}', '', 0, 0),
(4, 1, 'description', 'Description', '1.2', '{}', '', 0, 0),
(5, 1, 'link', 'link', '1.1', '{"required":true}', '', 0, 0),
(6, 1, 'ispublished', 'Is Published', '4.4', '{}', '', 0, 0);
...
(2, 'Cars', 'Cars Module', 'modules/4/index', 1);
